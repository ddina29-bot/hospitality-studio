      ...
      <div className="w-full max-w-sm bg-[#FDF8EE] h-full shadow-2xl border-l border-[#C5A059]/30 flex flex-col animate-in slide-in-from-right duration-300">
        <div className="p-6 border-b border-[#D4B476]/20 flex justify-between items-center bg-white">
           <div>
              ...
              <p className="text-[8px] font-black text-[#C5A059] uppercase tracking-[0.3em]">Live Updates</p>
           </div>
           <button onClick={onClose} className="w-8 h-8 flex items-center justify-center rounded-full bg-gray-50 hover:bg-gray-100 text-black/40 hover:text-black transition-all">
           ...
           {filteredNotifications.length === 0 ? (
             ...
             filteredNotifications.map((notif) => (
                <div 
                  ...
                  className={`p-4 rounded-2xl border shadow-sm cursor-pointer transition-all hover:scale-[1.02] flex gap-4 items-start ${
